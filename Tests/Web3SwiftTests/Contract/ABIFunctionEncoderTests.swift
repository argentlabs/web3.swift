...
class ABIFunctionEncoderTests: XCTestCase {
    ...
    func testGivenArrayOfAddressses_ThenEncodesCorrectly() {
        let addresses: [EthereumAddress] = [
            "0x26fc876db425b44bf6c377a7beef65e9ebad0ec3",
    ...
    func testGivenTupleAndArgument_ThenEncodesCorrectly() {
        ...
        do {
            ...
            XCTAssertEqual(
                try encoder.encoded().web3.hexString,
    ...
    func test_GivenLongTupleArgument_ThenEncodesCorrectly() {
        let tuple = LongTuple(
            value1: "https://ethereum.org/abcde",
    ...
    func test_GivenSomeArgumentsAndLongTuple_ThenEncodesCorrectly() {
        let tuple = LongTuple(
            value1: "https://ipfs.fleek.co/ipfs/bafybeib7trltlf567dqq3jvok73k7vpnkxdq3gf6evj2ltezzzzhquc6ea",
    ...
    func test_GivenLongTupleAndSimpleTupleOfTuples_EncodesCorrectly() {
        ...
        let tupleOfTuples = TupleOfTuples(
            value1: NumberTuple(value: 0),
