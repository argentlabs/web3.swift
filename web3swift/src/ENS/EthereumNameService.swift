...
protocol EthereumNameServiceProtocol {
    func resolve(address: EthereumAddress,
                 mode: ResolutionMode,
                 completion: @escaping((EthereumNameServiceError?, String?) -> Void)) -> Void

    func resolve(ens: String,
                 mode: ResolutionMode,
                 completion: @escaping((EthereumNameServiceError?, EthereumAddress?) -> Void)) -> Void

    func resolve(address: EthereumAddress,
                 mode: ResolutionMode) async throws -> String

    func resolve(ens: String,
                 mode: ResolutionMode) async throws -> EthereumAddress
}
...
extension EthereumNameService {
    private func getResolver(for address: EthereumAddress,
        ...
        do {
            ...
            let resolver = self.resolversByAddress[resolverAddress] ?? ENSResolver(address: resolverAddress,
                                                                                   client: client,
