...
class EthereumAccountTests: XCTestCase {
    ...
    func testLoadAccountAndAddress() {
        let account = try! EthereumAccount(address: TestConfig.publicKey, keyStorage: TestEthereumKeyStorage(privateKey: TestConfig.privateKey))
    ...
    func testSignHash() {
        let account = try! EthereumAccount(address: TestConfig.publicKey, keyStorage: TestEthereumKeyStorage(privateKey: "774681694ad86635346b6e9b92fa8aa4806265336dc6766623029a6264a162c1"))
    ...
    func testSignHex() {
        let account = try! EthereumAccount(address: TestConfig.publicKey, keyStorage: TestEthereumKeyStorage(privateKey: "2639f727ded571d584643895d43d02a7a190f8249748a2c32200cfc12dde7173"))
    ...
    func testSignTxHash() {
        let account = try! EthereumAccount(address: TestConfig.publicKey, keyStorage: TestEthereumKeyStorage(privateKey: "0x4646464646464646464646464646464646464646464646464646464646464646"))
